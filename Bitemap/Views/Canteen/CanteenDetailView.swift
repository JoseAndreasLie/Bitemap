...
struct CanteenDetailView: View {
    ...
    var body: some View {
        Text("This is Canteen Detail View")
//        VStack {
//            List {
...
//        Dictionary(grouping: canteen.menu) { $0.category }
//    }
//    
...
#Preview {
//    CanteenDetailView(canteen: Canteen(id: "1", nama: "Kantin A", location: Location(id: "loc1", name: "Gedung A", images: ["gedungA_1.jpg"], desc: ["Deskripsi lokasi"], long: 123.456, lat: -6.789), tags: [Tag(id: "t1", name: "Rice")], menu: [
