...
//    @ObservedObject var viewModel = CanteenViewModel()
//    @State private var showFilterSheet = false
//    @State private var isShowingFilter = false
    
    var body: some View {
        Text("This is the Explore view")
//        ZStack {
...
//                        // Canteen cards
//                        VStack {
//                            ForEach(viewModel.filteredKantins, id: \.self) { canteen in
//                                NavigationLink(destination: CanteenDetailView(canteen: canteen)) {
//                                    CanteenCard(
//                                        canteenName: canteen.nama,
//                                        image: canteen.location.images.last ?? canteen.location.images[0],
//                                        tags: canteen.tags,
